...
async function debugDealMapping() {
  const client = await pool.connect()

  try {
    console.log('🔍 Debugging deal mapping...\n')
    ...
    // Ejecutar la consulta exacta de getDealById
    ...
    console.log(`vehiculo_matricula: ${row.vehiculo_matricula}`)

    // Simular el mapeo que hace getDealById
    const vehiculo = {
      id: row.vehiculoId,
    ...
    // Verificar si el problema está en el tipo de dato
    console.log('\n🔍 Análisis de tipos:')
    console.log('====================')
    console.log(
      `typeof fechaMatriculacion: ${typeof vehiculo.fechaMatriculacion}`
    )
    console.log(
      `fechaMatriculacion === null: ${vehiculo.fechaMatriculacion === null}`
    )
    console.log(
      `fechaMatriculacion === undefined: ${vehiculo.fechaMatriculacion === undefined}`
    )
    console.log(`fechaMatriculacion truthy: ${!!vehiculo.fechaMatriculacion}`)

    if (vehiculo.fechaMatriculacion) {
      console.log(`Valor: "${vehiculo.fechaMatriculacion}"`)
      console.log(`Longitud: ${vehiculo.fechaMatriculacion.length}`)
      console.log(`Es string vacío: ${vehiculo.fechaMatriculacion === ''}`)
    }
  } catch (error) {
