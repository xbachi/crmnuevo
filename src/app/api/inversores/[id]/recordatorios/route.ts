...
export async function GET(
  ...
  try {
    ...
    console.log(
      `📅 [INVERSOR RECORDATORIOS] Obteniendo recordatorios para inversor ${inversorId}`
    )
    ...
    console.log(
      `✅ [INVERSOR RECORDATORIOS] Encontrados ${result.rows.length} recordatorios`
    )
...
export async function POST(
  ...
  try {
    ...
    console.log(
      `📅 [INVERSOR RECORDATORIOS] Creando recordatorio para inversor ${inversorId}`
    )
    ...
    console.log(
      `✅ [INVERSOR RECORDATORIOS] Recordatorio creado:`,
      result.rows[0]
    )
...
export async function PUT(
  ...
  try {
    ...
    const body = await request.json()
    console.log(
      `📅 [INVERSOR RECORDATORIOS] Actualizando recordatorio para inversor ${inversorId}`
    )
    ...
    values.push(recordatorioId, inversorId)
    ...
    console.log(
      `✅ [INVERSOR RECORDATORIOS] Recordatorio actualizado:`,
      result.rows[0]
    )
    return NextResponse.json(result.rows[0])
  } catch (error) {
...
export async function DELETE(
  ...
  try {
    ...
    console.log(
      `📅 [INVERSOR RECORDATORIOS] Eliminando recordatorio ${recordatorioId} del inversor ${inversorId}`
    )
