      ...
      <div className="min-h-full bg-gradient-to-br from-slate-50 via-orange-50 to-red-100">
        <main className="w-[80%] mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
          ...
          <ConfirmDeleteModal
            ...
            title="Eliminar interesado"
            message="¿Estás seguro de eliminar este interesado? Esta acción no se puede deshacer."
            fileName={
              interesadoToDelete
                ? `${capitalizeText(interesadoToDelete.nombre)} ${capitalizeText(interesadoToDelete.apellidos)}`.trim()
                : undefined
            }
