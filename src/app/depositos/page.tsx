                              ...
                              <div className="flex items-center space-x-6 flex-1">
                                ...
                                <div className="min-w-[140px] max-w-[140px]">
                                  <div
                                    ...
                                    title={`${deposito.cliente?.nombre || ''} ${deposito.cliente?.apellidos || ''}`.trim()}
                                  >
                                    {deposito.cliente?.nombre &&
                                    deposito.cliente?.apellidos
                                  ...
                                  {deposito.cliente?.telefono && (
                                    <div
                                      ...
                                      title={deposito.cliente.telefono}
                                    >
                                      {deposito.cliente.telefono}
                                    </div>
                                  )}
                                ...
                                <div className="min-w-[160px] max-w-[160px]">
                                  <div
                                    className="font-medium text-slate-900 truncate"
                                    title={`${deposito.vehiculo?.marca || ''} ${deposito.vehiculo?.modelo || ''}`.trim()}
                                  >
                                    {deposito.vehiculo?.marca &&
                                    deposito.vehiculo?.modelo
                                  ...
                                  <div
                                    className="text-sm text-slate-500 truncate"
                                    title={deposito.vehiculo?.matricula || ''}
                                  >
                                    {deposito.vehiculo?.matricula || '-'}
                                  </div>
                                </div>
