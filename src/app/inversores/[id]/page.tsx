        ...
        <div className="mb-6">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8 mb-6">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-semibold text-gray-900">Información del Inversor</h2>
              {!isEditing && (
                <button
                  onClick={handleEdit}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-md text-gray-600">
                      €{((parseFloat(editData.capitalAportado) || 0) - (parseFloat(editData.capitalInvertido) || 0)).toLocaleString()}
                    </div>
                  </div>
                </div>
        ...
        {filteredVehiculos.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">
              {searchTerm || estadoFilter ? 'No se encontraron vehículos' : 'Sin vehículos asignados'}
            </h3>
            ...
            <form onSubmit={(e) => {
              ...
              <div className="md:col-span-2">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    {editingVehiculo.fotoInversor ? 'Selecciona una nueva foto para reemplazar la actual' : 'Selecciona una foto para este vehículo'}
                  </p>
                </div>
