...
export default function CrearClientePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.nombre.trim() || !formData.apellidos.trim() || !formData.telefono.trim()) {
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-gray-600">Completa la información del cliente para agregarlo al CRM</p>
            </div>
            <button
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  <label htmlFor="direccion" className="block text-xs font-medium text-gray-600 mb-1">Dirección</label>
                  <input
                    type="text"
                    id="direccion"
                    name="direccion"
                ...
                <div>
                  <label htmlFor="ciudad" className="block text-xs font-medium text-gray-600 mb-1">Ciudad</label>
                  <input
                    type="text"
                    id="ciudad"
                    name="ciudad"
                ...
                <div>
                  <label htmlFor="provincia" className="block text-xs font-medium text-gray-600 mb-1">Provincia</label>
                  <input
                    type="text"
                    id="provincia"
                    name="provincia"
                ...
                <div>
                  <label htmlFor="codPostal" className="block text-xs font-medium text-gray-600 mb-1">Código Postal</label>
                  <input
                    type="text"
                    id="codPostal"
                    name="codPostal"
            ...
            {showIntereses && (
              <div className="p-4 bg-white rounded-lg border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                  <div>
                    <label htmlFor="intereses.precioMaximo" className="block text-sm font-medium text-gray-700 mb-1">
                      💰 Precio máximo (€)
                    </label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label htmlFor="intereses.kilometrajeMaximo" className="block text-sm font-medium text-gray-700 mb-1">
                  ...
                  <div>
                    <label htmlFor="intereses.añoMinimo" className="block text-sm font-medium text-gray-700 mb-1">
                      📅 Año mínimo
                    </label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label htmlFor="intereses.combustiblePreferido" className="block text-sm font-medium text-gray-700 mb-1">
                  ...
                  <div>
                    <label htmlFor="intereses.cambioPreferido" className="block text-sm font-medium text-gray-700 mb-1">
                      🔧 Tipo de cambio
                    </label>
                    <select
                  ...
                  <div>
                    <label htmlFor="intereses.formaPagoPreferida" className="block text-sm font-medium text-gray-700 mb-1">
                      💳 Forma de pago
                    </label>
                    <select
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Cómo llegó y notas adicionales (opcional)</p>
              </div>
            </div>
            
            <div className="space-y-4">
              <div>
                <label htmlFor="comoLlego" className="block text-sm font-medium text-gray-700 mb-1">
