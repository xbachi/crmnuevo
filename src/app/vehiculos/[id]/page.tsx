    ...
    <ProtectedRoute>
      <div className="min-h-screen bg-slate-50">
        ...
        <div className="w-full lg:w-[80%] mx-auto px-2 sm:px-4 lg:px-6 xl:px-8 py-2 sm:py-4 lg:py-6 xl:py-8">
          ...
          <div className="min-[1500px]:hidden mb-4 bg-white rounded-xl shadow-sm border border-slate-200 p-3 sm:p-4">
            <h2 className="text-base sm:text-lg font-semibold text-gray-900 mb-3">
              Estado
            </h2>

            <div className="flex flex-wrap items-center gap-2">
              {/* Mostrar solo un badge si Estado y Condición son iguales */}
              <span
                className={`px-2 sm:px-3 py-1 sm:py-2 rounded-lg text-xs sm:text-sm font-medium ${getEstadoColor(vehiculo.estado || 'inicial')}`}
              >
                {(vehiculo.estado || 'inicial').toUpperCase()}
              </span>

              {/* Mostrar Condición solo si es diferente del Estado */}
              {vehiculo.estado?.toLowerCase() !==
                getCondicionVehiculo().toLowerCase() && (
                <span
                  className={`px-2 sm:px-3 py-1 sm:py-2 rounded-lg text-xs sm:text-sm font-medium ${getCondicionColor(getCondicionVehiculo())}`}
                >
                ...
                <>
                  ...
                  {getCondicionVehiculo() !== 'vendido' && (
                    ...
                    >
                      ...
                      <span className="hidden min-[400px]:inline">Vendido</span>
                      <span className="min-[400px]:hidden">V</span>
                    </button>
                  )}
                  ...
                  {getCondicionVehiculo() !== 'disponible' && (
                    ...
                    >
                      ...
                      <span className="min-[400px]:hidden">D</span>
                    </button>
                  )}
                </>
              )}
