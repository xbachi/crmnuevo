                ...
                <div className="p-4 sm:p-6">
                  ...
                  {activeTab === 'general' && (
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 sm:gap-3 lg:gap-6">
                        {/* Marca y Modelo */}
                        <div className="lg:col-span-4 bg-blue-50 border border-blue-200 rounded-lg p-1.5 sm:p-2 lg:p-4">
                        ...
                        {/* KMs, Fecha y Color */}
                        <div className="lg:col-span-4 bg-orange-50 border border-orange-200 rounded-lg p-1.5 sm:p-2 lg:p-4">
                          <div className="flex items-center space-x-1 sm:space-x-2 mb-1 lg:mb-3">
