              ...
              <div className="overflow-x-auto">
                <table className="w-full divide-y divide-slate-200 min-w-[600px]">
                  <thead className="bg-gradient-to-r from-slate-50 to-slate-100">
                    <tr>
                      <th className="px-2 lg:px-3 py-2 lg:py-4 text-left text-xs lg:text-sm font-bold text-slate-700 uppercase tracking-wider w-auto">
                        Ref.
                      </th>
                  ...
                  <tbody className="bg-white divide-y divide-slate-200">
                    {filteredVehiculos.map((vehiculo, index) => {
                      ...
                      return (
                        ...
                        >
                          <td className="px-2 lg:px-3 py-2 lg:py-4 w-auto">
