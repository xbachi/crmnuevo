        ...
        <div className="mb-4 sm:mb-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="flex items-center space-x-3 sm:space-x-4">
                  ...
                  <div className="min-w-0">
                    <h1 className="text-lg sm:text-xl font-bold text-white">Vehículos</h1>
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-slate-200/60 p-3 sm:p-4 space-y-3 sm:space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
              ...
              <div className="flex-1">
                <div className="relative">
                  ...
                  />
                  <svg className="absolute left-2 sm:left-3 top-2.5 h-4 w-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs sm:text-sm font-medium text-slate-600 hidden sm:inline">👁️ Vista:</span>
                <span className="text-xs sm:text-sm font-medium text-slate-600 sm:hidden">👁️</span>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-4 sm:gap-8 lg:gap-12">
              ...
              {/* Ordenamiento */}
              <div className="flex items-center gap-2">
                <span className="text-xs sm:text-sm font-medium text-slate-600">📊 Orden:</span>
                <button
