...
const VehicleCard = memo(function VehicleCard({
  ...
  return (
    <div
      className={`rounded-xl border shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden group bg-white border-gray-200 w-full min-w-[330px] mx-[20px] my-[10px] ${
