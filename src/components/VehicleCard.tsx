...
const VehicleCard = memo(function VehicleCard({
  ...
  return (
    <div
      className={`rounded-xl border shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden group bg-white border-gray-200 w-full min-w-[320px] max-w-none mx-[10px] my-[10px] ${
