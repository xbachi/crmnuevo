...
interface VehicleFormProps {
  ...
  /** Error de la API para la matrícula, mostrado bajo el input. */
  errorMatricula?: string | null
}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            required
            aria-invalid={!!errorMatricula}
            aria-describedby={errorMatricula ? 'matricula-error' : undefined}
          ...
          <CampoError
            id="matricula-error"
            mensaje={errorMatricula ?? undefined}
          />
