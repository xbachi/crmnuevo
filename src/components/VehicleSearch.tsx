...
export default function VehicleSearch({ onVehicleSelect, placeholder = "Buscar vehículo...", className = "" }: VehicleSearchProps) {
  ...
  const handleVehicleSelect = (vehiculo: Vehiculo) => {
    setQuery(`${vehiculo.marca} ${vehiculo.modelo} ${vehiculo.año}`)
    setIsOpen(false)
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-gray-500 truncate">
                        {vehiculo.año} • {vehiculo.color} • {vehiculo.combustible}
                      </p>
                      <p className="text-xs text-gray-400 truncate">
                        {formatKilometraje(vehiculo.kilometraje)} • {vehiculo.cambio}
                      </p>
                    </div>
                  </div>
                </div>
