        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="text-center">
            ...
            <p className="text-3xl font-bold text-purple-600">
              {Math.round(metrics.diasPromedioEnStock)}
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p
                className={`text-2xl font-semibold ${metrics.capitalDisponible >= 0 ? 'text-emerald-600' : 'text-red-600'}`}
              >
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p
                className={`text-2xl font-semibold ${metrics.beneficioAcumulado >= 0 ? 'text-green-600' : 'text-red-600'}`}
              >
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p
                className={`text-2xl font-semibold ${metrics.roi >= 0 ? 'text-green-600' : 'text-red-600'}`}
              >
      ...
      {(periodo || ultimaActualizacion) && (
        <div className="bg-gray-50 rounded-lg p-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between text-sm text-gray-600">
            {periodo && (
              <p>
                <span className="font-medium">Periodo:</span> {periodo}
              </p>
            )}
            {ultimaActualizacion && (
              <p>
