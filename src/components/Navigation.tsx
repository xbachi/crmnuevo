...
const DashboardIcon = ({ isCollapsed }: { isCollapsed: boolean }) => (
  <svg className={isCollapsed ? "w-8 h-8" : "w-6 h-6"} fill="currentColor" viewBox="0 0 20 20">
...
const DocumentacionIcon = ({ isCollapsed }: { isCollapsed: boolean }) => (
  <svg className={isCollapsed ? "w-8 h-8" : "w-6 h-6"} fill="none" stroke="currentColor" viewBox="0 0 24 24">
