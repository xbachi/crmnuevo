...
export default function KanbanColumn({ 
  ...
  return (
    <div className="flex flex-col h-full w-full">
      ...
      <div className={`${color} px-3 py-2 rounded-t-md flex items-center justify-between flex-shrink-0`}>
      ...
      <div
        ref={setNodeRef}
        className="flex-1 bg-slate-100 p-2 rounded-b-md min-h-[300px] max-h-[600px] overflow-y-auto"
      >
        <SortableContext items={vehiculos.map(v => v.id)} strategy={verticalListSortingStrategy}>
