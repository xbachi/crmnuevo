...
export const SHEETS_CONFIG = {
  ...
  HEADERS: ['REFERENCIA', 'MARCA', 'MODELO', 'MATRICULA', 'BASTIDOR', 'KMS'],
...
/** Pestaña de Ventas y de Compras para cualquier variante de tipo (letra o palabra). */
export function resolverTipoSheets(tipo: string | null | undefined): {
  ventas: string
  compras: string
} {
  const t = normalizarTipo(tipo)
  if (t === 'D') return { ventas: 'Deposito', compras: 'Deposito' }
